...
public class QueryRunnerTest {
    ...
    public void testInsert() {
        ...
        try {
            ...
            int insertCount = runner.update(conn, sql, "蔡徐坤",2,"1997-09-08");
    ...
    public void testQuery1(){
        ...
        try {
            QueryRunner runner = new QueryRunner();
            conn = JDBCUtils1.getConnection3();
            String sql = "select id,name,sex,birth from user where id = ?";
    ...
    public void testQuery3(){
        ...
        try {
            ...
            Map<String, Object> map = runner.query(conn, sql, handler, 11);
...
//					return new Customer(12, "成龙", "Jacky@126.com", new Date(234324234324L));
                    ...
                    if(rs.next()){
                        ...
                        Customer customer = new Customer(id, name,sex, birth);
                        return customer;
                    }
                    return null;
